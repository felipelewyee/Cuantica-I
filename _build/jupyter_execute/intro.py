...
Copie y pegue la siguiente línea que hará que cada vez que habra Ubuntu se diriga a la carpeta de su usuario en windows. Reemplace `<Sustituya por su usuario de Windows>` por el nombre de su usuario.
```
