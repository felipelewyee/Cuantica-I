...
# :class: attention
# Realmente queremos resaltar lo importante que es intentar resolver los problemas antes de revelar la respuesta. Al inicio puede ser retador, pero la recompensa que se obtiene en `conocimiento` y `habilidad` es grande. Confiamos en su `creatividad`, y si algo resulta particularmente retador, siempre podemos aprender de la respuesta oculta.
# ```
