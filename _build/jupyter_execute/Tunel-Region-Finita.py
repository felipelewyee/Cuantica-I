...
# |:----------------:|:---------:|:--------:|:--------:|
# | I | $- \frac{\hbar^2}{2m} \frac{d^2}{dx^2}$ | $\psi_{\rm I}(x) = Ae^{ik_1x} + Be^{-ik_1x}$ | $k_1^2 = \frac{2mE}{\hbar^2}$ |
# | II| $- \frac{\hbar^2}{2m} \frac{d^2}{dx^2} + V$ | $\psi_{\rm II}(x) = C e^{-k_2x} + De^{k_2x}$ | $k_2^2 = \frac{2m(V-E)}{\hbar^2}$ |
# | III | $- \frac{\hbar^2}{2m} \frac{d^2}{dx^2}$ | $\psi_{\rm III}(x) = Fe^{ik_1x} + Ge^{-ik_1x}$ | $k_1^2 = \frac{2mE}{\hbar^2}$ |
# ```
# 
...
# |:---: |:---: | :---:|
# | I y II | $\psi_{\rm I}(0) = \psi_{\rm II}(0)$ | $A + B = C + D$ |
# | I y II | $\frac{d\psi_{\rm I}}{dx}(0) = \frac{d\psi_{\rm II}}{dx}(0)$ | $ik_1 (A - B) = -k_2 (C - D)$|
# |   III  | La partícula viaja hacia la derecha | $G = 0$ |
# | II y III | $\psi_{\rm II}(L) = \psi_{\rm III}(L)$ | $Ce^{-k_2L} + De^{k_2L} = F e^{ik_1L}$|
# | II y III | $\frac{d\psi_{\rm II}}{dx}(L) = \frac{d\psi_{\rm III}}{dx}(L)$ | $-k_2 C e^{-k_2L} + k_2 D e^{k_2L}  = ik_1F e^{ik_1L}$|
# 
...
# ```
# 
# El coeficiente de transmisión se puede calcular al dividir el cuadrado del coeficiente de la parte de la función que representa el paso de partículas a la región III (coeficiente F), entre el cuadrado del coeficiente de la parte de la función de onda que representa a la partícula dirigiéndose hacia la región I (coeficiente A).
# 
# $$
